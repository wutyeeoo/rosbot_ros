...
#include "rosbot_gazebo/gui/e_stop.hpp"

#include <gz/common/Console.hh>
#include <gz/gui/Application.hh>
#include <gz/plugin/Register.hh>

namespace rosbot_gazebo
{
...
void EStop::SetNamespace(const QString & ns)
{
  ...
  if (!namespace_.empty() && namespace_.back() == '/') namespace_.pop_back();
...
GZ_ADD_PLUGIN(rosbot_gazebo::EStop, gz::gui::Plugin)
